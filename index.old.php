...
<section class="services">
    <div class="container">
        <p class="blurb-info-paragraph">
            Développeur web expérimenté dans le Framework Symfony, je suis habitué à livrer des fonctionnalités aux clients finaux.
            ...
            du brief jusqu’à la livraison, mon alternance m'a permis d'approfondir mon apprentissage de l'organisation en ESN et de la recherche de solutions adaptées aux projets.
        </p>
        <div class="media-object">
            ...
            <div class="blurb-wrapper-right">
                ...
                <div class="blurb-info">
                    <p>Je suis à l'aise avec les fondamentaux du développement web, ainsi qu'avec les modèles de disposition unidimensionnel (Flex) et bidimensionnel (Grid).</p>
                </div>
            </div>
        </div>
...
<section class="portfolio">
    ...
    <div class="container">
        ...
        <div class="portfolio-wrapper">
            <div class="portfolio-object">
                <a href="https://github.com/radoibogdan/symfony4-assum"><img src="assets/symfony_projet.png" class="portfolio-box"></img></a>
                <h4>Projet Symfony 4.4</h4>
                <div class="portfolio-text">Projet plateforme produits assurance-vie disponible sur <a href="https://github.com/radoibogdan/symfony4-assum">Github</a></div>
            </div>
            <div class="portfolio-object">
